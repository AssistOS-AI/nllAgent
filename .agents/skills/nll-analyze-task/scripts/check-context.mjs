...
const role = "task analysis";
const expectedPurpose = "ANALYZE";
...
requirePopulated(context, "ontology", diagnostics,
  "analysis requires at least one active ontology signature");
requirePopulated(context, "circuits", diagnostics,
  "analysis requires at least one selected trained circuit");
requirePopulated(context, "providers", diagnostics,
  "analysis requires deterministic provider pins");
requirePopulated(context, "sdkImports", diagnostics,
  "analysis requires explicit LongTextJS SDK imports");
requirePopulated(context, "commands", diagnostics,
  "analysis requires source and LongTextJS validation commands");
...
function finish(value, found) {
  ...
  process.stdout.write(`selected circuits: ${collectionSize(value.circuits)}\n`);
