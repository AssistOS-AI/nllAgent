  ...
  nodes: [
    {
      ...
      inputs: {
        ...
        rules: [{
          id: 'ED-002', term: 'parcă', maximum: 2, wholeWord: true,
          caseSensitive: false, locale: 'ro', scopeKinds: ['document.paragraph@1'],
          excludedPrefixes: ['—', '–'], verdict: 'editorial-warning', severity: 'warning',
