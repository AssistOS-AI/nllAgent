export default circuit({
  ...
  version: '3.1.0',
  description: 'Compile a prose idea into an ordered, idea-specific CNL generation plan under the released editorial theory.',
  ...
  nodes: [
    {
      ...
      inputs: {
        ...
        plan: {
          ...
          document: {
            type: 'short literary scene in Markdown',
            language: 'Romanian',
          ...
          realizationGuidance: [
            ...
            'Do not use the whole phrase “de fapt” in narrative paragraphs.',
            'Use the whole word “parcă” no more than twice in any one narrative paragraph.',
